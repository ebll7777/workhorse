...
const paintingPrintDetails = ["Fine art print", "Dimensions to be confirmed", "EUR 40 + delivery"];
...
const drawingFiles = [
  ...
  "Inside The Cabin Of The Car.png",
  "Jack.png",
  "Jesus truck.png",
  "King Kong.png",
  "Korean fried chicken.png",
  "Shmoke.png",
  "Russian Nesting Dolls.png",
  "Ooh yea.png",
  "pac.png",
  "Pen plaza 2.png",
  "Pen plaza.png",
...
export const products = [
  ...
  },
  {
    ...
    thumbnail: productAsset("Furniture", "dance.gif"),
    media: [
      {
  ...
  },
  {
    ...
    media: [
      ...
      {
        src: productAsset("Paintings", "The Tourist Top.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Tourist Top.webp"),
        label: "The Tourist Top",
      },
      {
        src: productAsset("Paintings", "The Tourist Middle.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Tourist Middle.webp"),
        label: "The Tourist Middle",
      },
      {
        src: productAsset("Paintings", "The Tourist Bottom.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Tourist Bottom.webp"),
        label: "The Tourist Bottom",
      },
    ],
  ...
  },
  {
    ...
    media: [
      {
        src: productAsset("Paintings", "The Berliner.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Berliner.webp"),
        label: "The Berliner",
      },
      {
        src: productAsset("Paintings", "The Berliner Top.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Berliner Top.webp"),
        label: "The Berliner Top",
      },
      {
        src: productAsset("Paintings", "The Berliner Middle.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Berliner Middle.webp"),
        label: "The Berliner Middle",
      },
      {
        src: productAsset("Paintings", "The Berliner Bottom.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Berliner Bottom.webp"),
        label: "The Berliner Bottom",
      },
    ],
    details: ["Oil, Acrylic on canvas", "160cm x 36cm"],
    description: "Oil, Acrylic on canvas. 160cm x 36cm.",
  },
  {
    ...
    media: [
      {
        src: productAsset("Paintings", "The Geisha.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Geisha.webp"),
        label: "The Geisha",
      },
      {
        src: productAsset("Paintings", "The Geisha Top.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Geisha Top.webp"),
        label: "The Geisha Top",
      },
      {
        src: productAsset("Paintings", "The Geisha Middle.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Geisha Middle.webp"),
        label: "The Geisha Middle",
      },
      {
        src: productAsset("Paintings", "The Geisha Bottom.webp"),
        thumbnail: productAsset("Paintings", "thumbs/The Geisha Bottom.webp"),
        label: "The Geisha Bottom",
      },
    ],
    details: ["Oil, Acrylic on canvas", "160cm x 36cm"],
    description: "Oil, Acrylic on canvas. 160cm x 36cm.",
  },
  {
    id: 105,
    code: "PT-12",
    title: "Saphira And The Tiger",
    category: "Paintings",
    price: 460,
    image: productAsset("Paintings", "Saphira And The Tiger.webp"),
    thumbnail: productAsset("Paintings", "thumbs/Saphira And The Tiger.webp"),
    details: ["Painting on canvas", "82cm x 82cm"],
    description: "Painting on canvas. 82cm x 82cm.",
  },
  {
    id: 100,
    code: "PT-07",
  ...
  },
  {
    id: 200,
    code: "PR-01",
    title: "Baby Drag Print",
    category: "Prints",
    price: 40,
    image: productAsset("Paintings", "Baby Drag.webp"),
    thumbnail: productAsset("Paintings", "thumbs/Baby Drag.webp"),
    details: paintingPrintDetails,
    description: paintingPrintDetails.join(". "),
    hideFromHome: true,
  },
  {
    id: 201,
    code: "PR-02",
    title: "February First Print",
    category: "Prints",
    price: 40,
    image: productAsset("Paintings", "February First.webp"),
    thumbnail: productAsset("Paintings", "thumbs/February First.webp"),
  ...
  },
  {
    id: 203,
    code: "PR-04",
    title: "Kwain The Unthinkable Print",
    category: "Prints",
    price: 40,
    image: productAsset("Paintings", "Kwain The Unthinkable.webp"),
    thumbnail: productAsset("Paintings", "thumbs/Kwain The Unthinkable.webp"),
  ...
  },
  {
    id: 208,
    code: "PR-09",
    title: "Saphira And The Tiger Print",
    category: "Prints",
    price: 40,
    image: productAsset("Paintings", "Saphira And The Tiger.webp"),
    thumbnail: productAsset("Paintings", "thumbs/Saphira And The Tiger.webp"),
